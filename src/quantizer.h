...
const std::vector<uint8_t> kDClookup = {
...
void QuantizeY(std::vector<int16_t> &, uint8_t);
void QuantizeUV(std::vector<int16_t> &, uint8_t);
void QuantizeY2(std::vector<int16_t> &, uint8_t);
void Quantize(std::vector<int16_t> &, uint8_t);
void DequantizeY(std::vector<int16_t> &, uint8_t) 
void DequantizeUV(std::vector<int16_t> &, uint8_t) 
void DequantizeY2(std::vector<int16_t> &, uint8_t) 
void Dequantize(std::vector<int16_t> &, uint8_t) 
}; //namespace vp8
