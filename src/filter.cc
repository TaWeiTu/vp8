...
struct LoopFilter {
	...
	int16_t Adjust(bool use_outer_taps) {
		...
		int16_t a = Clamp128((use_outer_taps ? Clamp128(p1 - q1) : 0) + 3 * (q0 - p0));
	...
	void SubBlockFilter(int16_t hev_threshold, int16_t interior_limit, int16_t edge_limit) {
	...
	void MacroBlockFilter(int16_t hev_threshold, int16_t interior_limit, int16_t edge_limit) {
