...
struct LoopFilter {
	int16_t p3, p2, p1, p0;
	int16_t q0, q1, q2, q3;
	LoopFilter(int16_t P3, int16_t P2, int16_t P1, int16_t P0, int16_t Q0, int16_t Q1,int16_t Q2, int16_t Q3) {
		p3 = P3;
		p2 = P2;
		p1 = P1;
		p0 = P0;
...
template <size_t C>
void FrameFilter(FrameHeader &, uint8_t, std::vector<std::vector<MacroBlock<C>>>, size_t, size_t, bool, LoopFilter &);
}  // namespace vp8
#endif  // FILTER_H_
