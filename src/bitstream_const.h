#ifndef BITSTREAM_CONST_H_
#define BITSTREAM_CONST_H_
...
constexpr std::array<int8_t, 11> kTokenToCoeff = {0, 1,  2,  3,  4, 5,
                                                  7, 11, 19, 35, 67};
...
constexpr std::array<TreeIndex, 2 * (kNumDctTokens - 1)> kCoeffTree = {
    -DCT_EOB,  2,         -DCT_0,    4,         -DCT_1, 6,
    8,         12,        -DCT_2,    10,        -DCT_3, -DCT_4,
...
constexpr std::array<std::array<Prob, 4>, 6> kModeProb = {
    {{7, 1, 1, 143},
     {14, 18, 14, 107},
     {135, 64, 57, 68},
     {60, 56, 128, 65},
...
constexpr std::array<std::array<Prob, kMVPCount>, kNumMVDimen> kMVUpdateProbs =
    {{{237, 246, 253, 253, 254, 254, 254, 254, 254, 254, 254, 254, 254, 254,
       250, 250, 252, 254, 254},
      {231, 243, 245, 253, 254, 254, 254, 254, 254, 254, 254, 254, 254, 254,
       251, 251, 254, 254, 254}}};

constexpr std::array<std::array<Prob, kMVPCount>, kNumMVDimen>
    kDefaultMVContext = {{{162, 128, 225, 146, 172, 147, 214, 39, 156, 128, 129,
                           132, 75, 145, 178, 206, 239, 254, 254},
...
constexpr std::array<
    ...
    kNumIntraBModes>
    kKeyFrameBModeProbs = {{{{{{231, 120, 48, 89, 115, 113, 120, 152, 112}},
...
const std::vector<std::vector<Prob>> kPcat = {
    {159, 0},
    {165, 145, 0},
    {173, 148, 140, 0},
    {176, 155, 140, 135, 0},
